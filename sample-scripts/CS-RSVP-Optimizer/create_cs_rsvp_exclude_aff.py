...
def main(argv=None):
    ...
    with open(plan_file, 'rb') as file_r:
        ...
        for cs_rsvp_lsp in cs_rsvp_file_dict:
            ...
            cs_rsvp_assoc_id = cs_rsvp_lsp['AssociationID']
            cs_rsvp_traffic = cs_rsvp_lsp['Traffic']
            cs_exclude_working = str(cs_rsvp_lsp['ExcludeWorking'])
            cs_exclude_protect = str(cs_rsvp_lsp['ExcludeProtect'])
